...
const GOOGLE_CALLBACK_URL = process.env.GOOGLE_CALLBACK_URL; // Ye dashboard se aayega
    ...
    new GoogleStrategy(
        {
            ...
            callbackURL: GOOGLE_CALLBACK_URL, // Dynamic callback URL
        },
            ...
            try {
                ...
                if (existingUser) {
                    ...
                    const newUser = new User({
                        ...
                        image: {
                            url: profile._json.picture ? profile._json.picture.replace("=s96-c", "=s400-c") : "default_url_here",
                            filename: `google${profile.id}`,
                        },
                    });
                    let googleUser = await newUser.save();
                    console.log("New Google User Created:", googleUser.username);
